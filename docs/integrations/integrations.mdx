...
![Token de autenticação, mostrado ao habilitar a integração via API REST. Clique na imagem para ampliá-la.](./images/integration.webp
"Token de autenticação, mostrado ao habilitar a integração via API REST. Clique na imagem para ampliá-la.")
<p className="image-caption">Token de autenticação, mostrado ao habilitar a integração via API REST. Clique na imagem para ampliá-la.</p>
