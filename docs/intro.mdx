...
## Atores e Responsabilidades no Hashdata {#roles-and-responsibilities}
...
a interagir nas atividades específicas de coleta de dados daquela área de trabalho, de acordo com o modelo de negócio a
qual ela foi proposta.

### Proprietário da Área de Trabalho
- **Proprietário**: o proprietário da área de trabalho é a pessoa que adquiriu a licença de uso do Hashdata. A licença de uso
é associada a uma determinada área de trabalho e a quantidade de colaboradores que podem interagir nessa área de trabalho.
- **Responsabilidades**: o proprietário tem o controle total sobre sua área de trabalho, podendo adicionar ou remover
colaboradores, alterar configurações, gerenciar permissões e definir os limites de visibilidade e acesso. Além disso,
o proprietário também controla as configurações gerais, como planos de assinatura, que podem influenciar os recursos
disponíveis para os colaboradores.

> :bulb: **Dica!:** Para mais detalhes sobre o modelo de licenciamento do Hashdata, [entre em contato conosco](#user-support).

### Colaboradores na Área de Trabalho
- **Colaboradores**: o proprietário pode adicionar colaboradores à sua área de trabalho, até o limite que sua licença de uso permite.
Os colaboradores de uma ára de trabalho, a depender das permissões concedidas pelo proprietário, podem gerenciar formulários,
coletar dados, gerenciar dados coletados e gerenciar outros colaboradores.
- **Responsabilidades**: A depender do nível de permissão concedida a um colaborador, ele pode assumir todas as tarefas do
proprietário da área de trabalho, exceto alterar o nome, modificar a licença de uso e retirar o proprietário como membro da área
de trabalho.
...
pessoa pode somente acessar os formulários da área de trabalho a qual lhe foi dado acesso e não pode colaborar em outras
áreas de trabalho (uma conta de dispositivo está associada a somente uma área de trabalho). Além disso, essa conta não pode
ser destinatária de notificações e e-mails.
