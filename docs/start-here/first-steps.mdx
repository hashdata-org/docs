...
([saiba mais...](/#create-your-account)). Os colaboradores de uma ára de trabalho, a depender
...
[Saiba mais](/collaborators/managing-collaborators) como **Gerenciar Colaboradores**.
...
- **Contas de Dispositivo**: as contas de dispositivo são tipos especiais de contas, pois não estão vinculadas a uma
