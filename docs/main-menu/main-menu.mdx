...
import desktopEditImage from './images/header_desktop_edit.webp';
...
> :bulb: **Dica:** A figura a seguir mostra todas as funcionalidades presentes na **Tela Inicial**, clique nela para maximizá-la.
...
A opção **Mudar Área de Trabalho** permite a inclusão e a escolha de áreas de trabalho. A funcionalidade possibilita ao
**proprietário** mudar da área de trabalho  de acordo com uma área específica de negócio ou para compartilhar determinados
formulários com um colaborador.

**Para mudar a Área de Trabalho**:


![Mudar Área de Trabalho](./images/header_desktop.webp)

> :bulb: **Dica:** Utilize o campo de pesquisa (lupa) para localizar a área de trabalho desejada.

Para editar a área de trabalho:
1. Clique em *Editar* <img src={desktopEditImage} className="inline" alt="Editar Área de Trabalho" style={{width: 200, borderRadius: 20}}/>
2. Altere o nome da área de trabalho conforme desejado
3. Clique em salvar.

![Editar Área de Trabalho](./images/header_desktop_edit_detail.webp)
