...
export const mainMenuData = [
    {imgSrc: "/img/main-menu/start.webp", label: "Início", link: "/docs/main-menu/"},
    {imgSrc: "/img/main-menu/forms.webp", label: "Formulários", link: "/docs/category/"},
    ...
    {imgSrc: "/img/main-menu/user-guide.webp", label: "Guia do usuário", link: "/docs/"},
    {imgSrc: "/img/main-menu/advanced-reports.webp", label: "Hashdata Advanced Reports", link: "/calendar"},
];

<table style={{display: 'flex', justifyContent: "space-around", flexWrap: 'wrap'}}>
    <tbody>
...
5. **Acessar os formulários compartilhadas para você**;
